...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/km3io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13975&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/km3io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `km3io` can be installed with:

```
conda install km3io
```

It is possible to list all of the versions of `km3io` available on your platform with:
